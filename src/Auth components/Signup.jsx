            ...
            <div className='rounded-xl mx-auto p-4 max-w-[400px] bg-white'>
                <form method='GET' className='p-3 rounded-lg ' >
                    ...
                    {!loading && <div>
                        ...
                        <Link to="http://localhost:1337/api/connect/google" className='block text-center mt-4 rounded-xl w-full p-2 text-blue-950 hover:text-white hover:bg-blue-950 transition duration-200  font-bold border ' >Sign up with Google</Link>
